  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">Briki</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-[#0369A1] to-[#0C4A6E] text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
