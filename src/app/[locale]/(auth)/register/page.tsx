...
export const metadata: Metadata = {
  title: "Create account • Briki",
  description: "Create your Briki account and start managing policies.",
};
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base text-slate-600">
                  Get started with Briki and streamline your policy workflows.
                </p>
              </div>
