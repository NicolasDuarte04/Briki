...
export default async function DashboardPage({
  ...
  // If coming from Stripe checkout, revalidate profile to show new subscription
  if (awaitedSearchParams.session_id) {
    revalidatePath('/profile', 'layout');
    console.log('[Dashboard] Revalidating profile after checkout');
  }
