    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <CompanyForm 
        ...
        defaultValues={{
          ...
          financialCutDate: company.financialCutDate?.toISOString().split('T')[0] || '',
          annualPayroll: company.annualPayroll || '',
          ...(company.employeeCount != null && { employeeCount: company.employeeCount }),
