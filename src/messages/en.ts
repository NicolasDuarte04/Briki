const en = {
  ...
  profile: {
    ...
    accountSettings: {
      ...
      security: {
        title: "Password",
        description: "Reset your password by receiving a secure reset link via email. You'll be able to create a new password after clicking the link.",
      ...
      notifications: {
        ...
        policyAlertsDesc: "Get notified about important policy changes",
      },
      billing: {
        ...
        team: {
          name: "Team",
          description: "Collaborative tools for your organization",
        },
        ...
        status: {
          active: {
            label: "Active",
            description: "Your subscription is active and working properly",
          },
          trialing: {
            label: "Trial",
          ...
          unpaid: {
            label: "Unpaid",
            description: "Your subscription requires payment",
            action: "Update Payment Method",
          },
          incomplete: {
            label: "Incomplete",
            description: "Your subscription requires action",
